...
df_fechamento.insert(loc=0, column='EMPRESA', value=df_empresas)
...
civel_saldo_inicial = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'ADMINISTRATIVA') |
                                                          (df_fechamento_seq_colunas['NATUREZA'] == 'CIVEL') |
                                                          (df_fechamento_seq_colunas['NATUREZA'] == 'CRIMINAL') |
                                                          (df_fechamento_seq_colunas['NATUREZA'] == 'JEC') |
                                                          (df_fechamento_seq_colunas['NATUREZA'] == 'RECEBIVEIS') |
                                                          (df_fechamento_seq_colunas['NATUREZA'] == 'AMBIENTAL')]
                                                          ['PROVÁVEL MÊS ANTERIOR'].sum())
civel_novos_processos = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['TIPO'] == 'NOVO') & (df_fechamento_seq_colunas['NATUREZA'] == 'ADMINISTRATIVA') |
                                                            (df_fechamento_seq_colunas['TIPO'] == 'NOVO') & (df_fechamento_seq_colunas['NATUREZA'] == 'CIVEL') |
                                                            (df_fechamento_seq_colunas['TIPO'] == 'NOVO') & (df_fechamento_seq_colunas['NATUREZA'] == 'CRIMINAL') |
                                                            (df_fechamento_seq_colunas['TIPO'] == 'NOVO') & (df_fechamento_seq_colunas['NATUREZA'] == 'JEC') |
                                                            (df_fechamento_seq_colunas['TIPO'] == 'NOVO') & (df_fechamento_seq_colunas['NATUREZA'] == 'RECEBIVEIS') |
                                                            (df_fechamento_seq_colunas['TIPO'] == 'NOVO') & (df_fechamento_seq_colunas['NATUREZA'] == 'AMBIENTAL')]
                                                            ['PROVÁVEL ATUALIZADO'].sum())
civel_alt_prov_aumento = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['ALTERAÇÃO'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'ADMINISTRATIVA') |
                                                             (df_fechamento_seq_colunas['ALTERAÇÃO'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'CIVEL') |
                                                             (df_fechamento_seq_colunas['ALTERAÇÃO'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'CRIMINAL') |
                                                             (df_fechamento_seq_colunas['ALTERAÇÃO'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'JEC') |
                                                             (df_fechamento_seq_colunas['ALTERAÇÃO'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'RECEBIVEIS') |
                                                             (df_fechamento_seq_colunas['ALTERAÇÃO'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'AMBIENTAL')]
                                                             ['ALTERAÇÃO'].sum())
civel_alt_prov_diminuicao = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['ALTERAÇÃO'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'ADMINISTRATIVA') |
                                                             (df_fechamento_seq_colunas['ALTERAÇÃO'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'CIVEL') |
                                                             (df_fechamento_seq_colunas['ALTERAÇÃO'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'CRIMINAL') |
                                                             (df_fechamento_seq_colunas['ALTERAÇÃO'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'JEC') |
                                                             (df_fechamento_seq_colunas['ALTERAÇÃO'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'RECEBIVEIS') |
                                                             (df_fechamento_seq_colunas['ALTERAÇÃO'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'AMBIENTAL')]
                                                             ['ALTERAÇÃO'].sum())
civel_arquivamento = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['TIPO'] == 'ENCERRADO') & (df_fechamento_seq_colunas['NATUREZA'] == 'ADMINISTRATIVA') |
                                                         (df_fechamento_seq_colunas['TIPO'] == 'ENCERRADO') & (df_fechamento_seq_colunas['NATUREZA'] == 'CIVEL') |
                                                         (df_fechamento_seq_colunas['TIPO'] == 'ENCERRADO') & (df_fechamento_seq_colunas['NATUREZA'] == 'CRIMINAL') |
                                                         (df_fechamento_seq_colunas['TIPO'] == 'ENCERRADO') & (df_fechamento_seq_colunas['NATUREZA'] == 'JEC') |
                                                         (df_fechamento_seq_colunas['TIPO'] == 'ENCERRADO') & (df_fechamento_seq_colunas['NATUREZA'] == 'RECEBIVEIS') |
                                                         (df_fechamento_seq_colunas['TIPO'] == 'ENCERRADO') & (df_fechamento_seq_colunas['NATUREZA'] == 'AMBIENTAL')]
                                                         ['PROVÁVEL MÊS ANTERIOR'].sum())
civel_atualizacao = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'ADMINISTRATIVA') |
                                                        (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'CIVEL') |
                                                        (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'CRIMINAL') |
                                                        (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'JEC') |
                                                        (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'RECEBIVEIS') |
                                                        (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] > 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'AMBIENTAL')]
                                                        ['VALOR ATUALIZAÇÃO PROVÁVEL'].sum())
civel_reversao = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'ADMINISTRATIVA') |
                                                        (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'CIVEL') |
                                                        (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'CRIMINAL') |
                                                        (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'JEC') |
                                                        (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'RECEBIVEIS') |
                                                        (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] < 0) & (df_fechamento_seq_colunas['NATUREZA'] == 'AMBIENTAL')]
                                                        ['VALOR ATUALIZAÇÃO PROVÁVEL'].sum())
civil_saldo_final = civel_saldo_inicial + civel_novos_processos + civel_alt_prov_aumento + civel_alt_prov_diminuicao + civel_arquivamento +\
                          civel_atualizacao + civel_reversao

civel = [civel_saldo_inicial, civel_novos_processos, civel_alt_prov_aumento, civel_alt_prov_diminuicao, civel_arquivamento, civel_atualizacao, civel_reversao, civil_saldo_final]

# Criando os valores da coluna FISCAL

fiscal_saldo_inicial = float(df_fechamento_seq_colunas.loc[df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL']['PROVÁVEL MÊS ANTERIOR'].sum())
fiscal_novos_processos = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['TIPO'] == 'NOVO') & (df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL')]['PROVÁVEL ATUALIZADO'].sum())
fiscal_alt_prov_aumento = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL') & (df_fechamento_seq_colunas['ALTERAÇÃO'] > 0)]['ALTERAÇÃO'].sum())
fiscal_alt_prov_diminuicao = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL') & (df_fechamento_seq_colunas['ALTERAÇÃO'] < 0)]['ALTERAÇÃO'].sum())
fiscal_arquivamento = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL') & (df_fechamento_seq_colunas['TIPO'] == 'ENCERRADO')]['PROVÁVEL MÊS ANTERIOR'].sum())
fiscal_atualizacao = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL') & (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] > 0)]['VALOR ATUALIZAÇÃO PROVÁVEL'].sum())
fiscal_reversao = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL') & (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] < 0)]['VALOR ATUALIZAÇÃO PROVÁVEL'].sum())
fiscal_saldo_final = fiscal_saldo_inicial + fiscal_novos_processos + fiscal_alt_prov_aumento + fiscal_alt_prov_diminuicao + fiscal_arquivamento +\
                          fiscal_atualizacao + fiscal_reversao

fiscal = [fiscal_saldo_inicial, fiscal_novos_processos, fiscal_alt_prov_aumento, fiscal_alt_prov_diminuicao, fiscal_arquivamento, fiscal_atualizacao, fiscal_reversao, fiscal_saldo_final]

# Criando os valores da coluna REGULATÓRIO

regulatorio_saldo_inicial = float(df_fechamento_seq_colunas.loc[df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL']['PROVÁVEL MÊS ANTERIOR'].sum())
regulatorio_novos_processos = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['TIPO'] == 'NOVO') & (df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL')]['PROVÁVEL ATUALIZADO'].sum())
regulatorio_alt_prov_aumento = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL') & (df_fechamento_seq_colunas['ALTERAÇÃO'] > 0)]['ALTERAÇÃO'].sum())
regulatorio_alt_prov_diminuicao = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL') & (df_fechamento_seq_colunas['ALTERAÇÃO'] < 0)]['ALTERAÇÃO'].sum())
regulatorio_arquivamento = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL') & (df_fechamento_seq_colunas['TIPO'] == 'ENCERRADO')]['PROVÁVEL MÊS ANTERIOR'].sum())
regulatorio_atualizacao = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL') & (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] > 0)]['VALOR ATUALIZAÇÃO PROVÁVEL'].sum())
regulatorio_reversao = float(df_fechamento_seq_colunas.loc[(df_fechamento_seq_colunas['NATUREZA'] == 'FISCAL') & (df_fechamento_seq_colunas['VALOR ATUALIZAÇÃO PROVÁVEL'] < 0)]['VALOR ATUALIZAÇÃO PROVÁVEL'].sum())
regulatorio_saldo_final = regulatorio_saldo_inicial + regulatorio_novos_processos + regulatorio_alt_prov_aumento + regulatorio_alt_prov_diminuicao + regulatorio_arquivamento +\
                          regulatorio_atualizacao + regulatorio_reversao

regulatorio = [regulatorio_saldo_inicial, regulatorio_novos_processos, regulatorio_alt_prov_aumento, regulatorio_alt_prov_diminuicao, regulatorio_arquivamento, regulatorio_atualizacao, regulatorio_reversao, regulatorio_saldo_final]
...
saldo_atualizacao = float(trabalhista_atualizacao + civel_atualizacao + fiscal_atualizacao + regulatorio_atualizacao)
saldo_reversao = float(trabalhista_reversao + civel_reversao + fiscal_reversao + regulatorio_reversao)
saldo_saldo_final = saldo_saldo_inicial + saldo_novos_processos + saldo_alt_prov_aumento + saldo_alt_prov_diminuicao + saldo_arquivamento +\
                          saldo_atualizacao + saldo_reversao

saldo = [saldo_saldo_inicial, saldo_novos_processos, saldo_alt_prov_aumento, saldo_alt_prov_diminuicao, saldo_arquivamento, saldo_atualizacao, saldo_reversao, saldo_saldo_final]


Criando os arquivos das empresas
...
for temp in empresas:
    nome_arquivo_saida = mes + 'FECHAMENTO CONTENCIOSO ' + temp + '.xlsx'
    writer_temp = pd.ExcelWriter(nome_arquivo_saida, engine='xlsxwriter')
    df_base_ativa_temp = df_base_ativa.loc[df_base_ativa['EMPRESA'] == temp]
    df_encerrado_temp = df_encerrado.loc[df_encerrado['EMPRESA'] == temp]
    df_regularorio_temp = df_regularorio.loc[df_regularorio['EMPRESA'] == temp]
    df_base_ativa_temp.to_excel(writer_temp, sheet_name='BASE ATIVA', index=False)
    df_encerrado_temp.to_excel(writer_temp, sheet_name='ENCERRADOS', index=False)
    df_regularorio_temp.to_excel(writer_temp, sheet_name='REGULATÓRIO', index=False)
    writer_temp.save()
